...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form action="<?php echo e(route('admin.news.store')); ?>" enctype="multipart/form-data" method="POST" class="forms-sample">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
          ...
          <button class="btn btn-dark"><a href="<?php echo e(route('admin.news.index')); ?>">Geri</a></button>
        </form>
      </div>
    </div>
  </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Parviz\Desktop\aviasiya\resources\views/admin/pages/news/create.blade.php ENDPATH**/ ?>