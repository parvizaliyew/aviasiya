   ...
   <div class="container-fluid bg-primary text-white mt-5 pt-5 px-sm-3 px-md-5">
    <div class="row pt-5">
        <div class="col-lg-3 col-md-6 mb-5">
            <a href=""><h1 class="text-secondary mb-3"><span class="text-white">Avi</span>Asiya</h1></a>
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <div class="d-flex flex-column justify-content-start">
                ...
                <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Haqqımızda</a>
                <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Xəbərlər</a>
                <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Əlaqə</a>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 mb-5">
...
<div class="container-fluid bg-dark text-white py-4 px-sm-3 px-md-5">
    <p class="m-0 text-center text-white">
        &copy; <a class="text-white font-weight-medium" href="#">Aviasiya</a>. All Rights Reserved. by
...
</html><?php /**PATH C:\xampp\htdocs\aviasiya\resources\views/front/layouts/footer.blade.php ENDPATH**/ ?>